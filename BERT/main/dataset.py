...
class BertDataset(Dataset):
    def __init__(self, file_dict: str, max_seq_len: int, vocab_size: int):
        self.path = file_dict
    ...
    @delayed
    def load_chunk(self, pth: str) -> pd.DataFrame:
    ...
    def __getitem__(self, idx: int) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        # Pad normal sentence and label sentence by however much they need to get to max_seq_len
