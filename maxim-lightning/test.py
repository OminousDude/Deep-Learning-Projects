...
class DDPM(pl.LightningModule):
    def __init__(self, nn_model, betas, n_T, device, drop_prob=0.1, learning_rate=1e-4):
...
ddpm = DDPM(nn_model=ContextUnet(in_channels=3, n_feat=n_feat, n_classes=n_classes), betas=(1e-4, 0.02), n_T=n_T, device=device, drop_prob=0.1, learning_rate=l_rate)

trainer = pl.Trainer(accelerator=device, max_epochs=2)

trainer.fit(ddpm, train_dataloaders=dataloader)

trainer.validate(ddpm, dataloaders=dataloader)